import bg_footer from "../assets/6.webp";
...
const Footer = () => {
  return (
    <footer
      className="py-16 px-16 mobile:pt-5 bg-cover bg-center mobile:pb-20 flex justify-center items-center"
      style={{backgroundImage: `linear-gradient(270deg,#000,#0009) , url(${bg_footer})`,}}>
      <div className="container grid lg:grid-cols-4 grid-cols-1  justify-center">
        ...
        <div className="box  mobile:my-2">
          ...
          <div className="centerd  space-x-3  my-8">
        ...
        <div className="box">
          ...
          <div className="centerd space-x-2 my-6">
            <LazyLoadImage
